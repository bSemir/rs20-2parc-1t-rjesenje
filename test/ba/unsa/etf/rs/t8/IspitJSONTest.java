...
//            assertEquals("{[]}" +
    ...
    void testCitajGrad() {
        ...
        File file = new File("test.json");
        try {
            Files.writeString(file.toPath(), "[{\"gradovi\":[{\"datumOsnivanja\":\"1462-02-01\",\"brojStanovnika\":350000,\"naziv\":\"Sarajevo\"},{\"datumOsnivanja\":\"1970-01-01\",\"brojStanovnika\":1000,\"glavni\":true,\"naziv\":\"Čekrčići\"}],\"naziv\":\"BiH\"}]");
        } catch (IOException e) {
            e.printStackTrace();
        }
        try {
    ...
    void testPogresanFormat() {
        ...
        String[] pogresni = {
                ...
                "[{\"gradovii\":[{\"datumOsnivanja\":\"1462-02-01\",\"brojStanovnika\":350000,\"naziv\":\"Sarajevo\"},{\"datumOsnivanja\":\"1970-01-01\",\"brojStanovnika\":1000,\"glavni\":true,\"naziv\":\"Čekrčići\"}],\"naziv\":\"BiH\"}]",
                // Država nema naziv (umjesto toga nazivi)
                "[{\"gradovi\":[{\"datumOsnivanja\":\"1462-02-01\",\"brojStanovnika\":350000,\"naziv\":\"Sarajevo\"},{\"datumOsnivanja\":\"1970-01-01\",\"brojStanovnika\":1000,\"glavni\":true,\"naziv\":\"Čekrčići\"}],\"nazivi\":\"BiH\"}]",
                // Grad nema naziv (umjesto toga nazivi)
                "[{\"gradovi\":[{\"datumOsnivanja\":\"1462-02-01\",\"brojStanovnika\":350000,\"nazivi\":\"Sarajevo\"},{\"datumOsnivanja\":\"1970-01-01\",\"brojStanovnika\":1000,\"glavni\":true,\"naziv\":\"Čekrčići\"}],\"naziv\":\"BiH\"}]",
                // Grad nema broj stanovnika
                "[{\"gradovi\":[{\"datumOsnivanja\":\"1462-02-01\",\"brojStanovnika\":350000,\"naziv\":\"Sarajevo\"},{\"datumOsnivanja\":\"1970-01-01\",\"brojSeljaka\":1000,\"glavni\":true,\"naziv\":\"Čekrčići\"}],\"naziv\":\"BiH\"}]",
                // Nijedan grad nije glavni
                "[{\"gradovi\":[{\"datumOsnivanja\":\"1462-02-01\",\"brojStanovnika\":350000,\"naziv\":\"Sarajevo\"},{\"datumOsnivanja\":\"1970-01-01\",\"brojStanovnika\":1000,\"naziv\":\"Čekrčići\"}],\"naziv\":\"BiH\"}]",
        };
